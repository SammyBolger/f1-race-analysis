...
class F1RaceReplayWindow(arcade.Window):
    def __init__(self, frames, track_statuses, example_lap, drivers, title,
        ...
        self.leaderboard_comp = LeaderboardComponent(x=leaderboard_x, width=240, visible=visible_hud, top_offset=55)  # Shifted down for back button
        self.weather_comp = WeatherComponent(left=20, top_offset=185, visible=visible_hud)  # Shifted down for back button
        ...
        # Back to Home Button - positioned at very top left
        self.back_btn_x = 20
        self.back_btn_y = self.height - 15
        self.back_btn_w = 120
        self.back_btn_h = 30
        self.back_btn_hovered = False
        ...
        # Positioned lower to leave room for back button at top
        self.lap_text = arcade.Text("", 20, self.height - 55, arcade.color.WHITE, 24, anchor_y="top")
        self.time_text = arcade.Text("", 20, self.height - 95, arcade.color.WHITE, 20, anchor_y="top")
        self.status_text = arcade.Text("", 20, self.height - 135, arcade.color.WHITE, 24, bold=True, anchor_y="top")
    ...
    def on_resize(self, width, height):
        ...
        # update persistent text positions - shifted down for back button
        self.lap_text.x = 20
        self.lap_text.y = self.height - 55
        self.time_text.x = 20
        self.time_text.y = self.height - 95
        self.status_text.x = 20
        self.status_text.y = self.height - 135
        # Update back button position for new window size
        self.back_btn_y = height - 10
    ...
    def on_draw(self):
        ...
        # Draw Back to Home Button LAST so nothing covers it
        # Draw dark background panel first for contrast
        panel_padding = 5
        panel_rect = arcade.XYWH(
            self.back_btn_x + self.back_btn_w/2,
            self.back_btn_y - self.back_btn_h/2,
            self.back_btn_w + panel_padding*2,
            self.back_btn_h + panel_padding*2
        )
        arcade.draw_rect_filled(panel_rect, (30, 30, 30, 220))
        # Draw button
        btn_color = (204, 0, 0) if not self.back_btn_hovered else (255, 50, 50)
        btn_rect = arcade.XYWH(
            self.back_btn_x + self.back_btn_w/2,
            self.back_btn_y - self.back_btn_h/2,
            self.back_btn_w,
            self.back_btn_h
        )
        arcade.draw_rect_filled(btn_rect, btn_color)
        arcade.draw_rect_outline(btn_rect, (255, 255, 255, 100), 1)
        arcade.draw_text("BACK TO HOME", self.back_btn_x + self.back_btn_w/2, self.back_btn_y - self.back_btn_h/2, arcade.color.WHITE, 11, anchor_x="center", anchor_y="center", bold=True)
    ...
    def on_mouse_press(self, x: float, y: float, button: int, modifiers: int):
        ...
        if self.back_btn_x <= x <= self.back_btn_x + self.back_btn_w and \
           self.back_btn_y - self.back_btn_h <= y <= self.back_btn_y:
            self.close()
            return
    ...
    def on_mouse_motion(self, x: float, y: float, dx: float, dy: float):
        ...
        self.back_btn_hovered = (self.back_btn_x <= x <= self.back_btn_x + self.back_btn_w and
                                 self.back_btn_y - self.back_btn_h <= y <= self.back_btn_y)
